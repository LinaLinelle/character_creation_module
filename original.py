...
def attack(char_name: str, char_class: str) -> str:
    """Считает урон от атаки для каждого класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Считает количество заблокированного урона для каждого класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Повышает одну из характеристик в зависимости от класса."""
    if char_class == 'warrior':
